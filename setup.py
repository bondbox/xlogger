...
from xkits_logger.attribute import __description__
from xkits_logger.attribute import __project__
from xkits_logger.attribute import __urlhome__
from xkits_logger.attribute import __version__
...
setup(
    ...
    packages=find_packages(include=["xkits_logger*"], exclude=["xkits_logger.unittest"]),  # noqa:E501
